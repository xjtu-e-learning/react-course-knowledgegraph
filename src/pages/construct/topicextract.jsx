      ...
      <div>
        <div style={{marginBottom: 16}}>
          ...
          <Button type="primary" onClick={this.startExtract}>
            ...
            {extractState !== 'start' && (extractState === 'processing' ? <Icon type="loading" /> : <Icon type="check" />)}
          </Button>
          {extractState === 'finish' && <Link to='/construct/dependencemining'><Button style={{marginLeft: 16}} type={"primary"} onClick={this.next}>下一步</Button></Link>}
        </div>
